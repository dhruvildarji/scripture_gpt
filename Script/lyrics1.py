...
def prep_dataset():
    ...
    ### Prepare data
    lyrics = pd.read_csv(r'D:/gpt2/TensorRT-LLM/examples/gpt\data/lyrics-data.csv')
    print(lyrics.head)
    lyrics = lyrics[lyrics['language']=='en']

    #Only keep popular artists, with genre Rock/Pop and popularity high enough
    artists = pd.read_csv(r'D:/gpt2/TensorRT-LLM/examples/gpt\data/artists-data.csv')
